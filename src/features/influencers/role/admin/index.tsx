      ...
      onChange: async (params, setPage) => {
        const formattedParams = {
          ...
          diseaseAreaIds: filter.diseaseAreas.length
            ...
            : undefined,
          symptomIds: filter.symptoms.length
            ? getStateValueAsNumArray(filter.symptoms)
            : undefined,
          ...
          audienceSymptomChoiceIds: filter.audienceSymptomChoices.length
            ? getStateValueAsNumArray(filter.audienceSymptomChoices)
            : undefined,
          audienceSymptomCount: filter.audienceSymptomCount.length
            ? handleFormatParamKey(+filter.audienceSymptomCount, 'number')
            : undefined,
          audienceSymptomUnitId: handleFormatParamKey(
            filter.audienceSymptomUnit
          ),
                    ...
                    elements={[
                      {
                        type: 'multiselect',
                        placeholder: 'Please Select',
                        value: filter.audienceSymptomChoices,
                        onValue: (audienceSymptomChoices) =>
                          setFilter({ ...filter, audienceSymptomChoices }),
                        options: symptomOptions,
                      },
                      {
                        type: 'number',
                        placeholder: 'Number',
                        value: filter.audienceSymptomCount,
                        onValue: (audienceSymptomCount) =>
                          setFilter({ ...filter, audienceSymptomCount }),
                      },
                      {
                        type: 'select',
                        placeholder: 'Units',
                        value: filter.audienceSymptomUnit,
                        onValue: (audienceSymptomUnit) => {
                          if (audienceSymptomUnit) {
                            setFilter({ ...filter, audienceSymptomUnit });
                          } else {
                            setFilter({
                              ...filter,
                              audienceSymptomUnit: {
