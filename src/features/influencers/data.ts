...
export interface IInfluencerFilterProps {
  ...
  audienceSymptomChoices: ISelectField[];
  audienceSymptomCount: string;
  audienceSymptomUnit: ISelectField | null;
...
export const DGenerateInfluencersFilter = (): IInfluencerFilterProps => ({
  ...
  audienceSymptomChoices: [],
  audienceSymptomCount: '',
  audienceSymptomUnit: {
    value: '1',
    label: '#',
  },
